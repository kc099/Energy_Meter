...
urlpatterns = [
    ...
    path("devices/<int:device_id>/provision", views.device_provision_view, name="device-provision"),
    path("devices/claim", views.device_claim_view, name="device-claim"),
    path("device-data/ingest", views.device_data_ingest_view, name="device-data-ingest"),
